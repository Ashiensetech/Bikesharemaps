...
if (isset($_POST["text"]))
   ...
   fopen("https://".$_SERVER['HTTP_HOST'].$dirname."/receive.php?sms_text=".urlencode($_POST["text"])."&sms_uuid=test&sender=".$usenumber."&receive_time=".urlencode(date("Y-m-d H:i:s")),"r");
   }
