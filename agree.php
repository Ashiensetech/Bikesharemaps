...
<head>
<meta charset="UTF-8" />
<title><?php echo $systemname; ?> <?php echo _('account activation'); ?></title>
...
<?php
 ...
 confirmUser($userkey);
?>
<div class="alert alert-success" role="alert"><?php echo _('Your account has been activated. Welcome!'); ?></div>
<div class="alert alert-warning" role="alert">
<p><?php echo _('By registering I confirm that I have read:'); ?> <a href="user_agreement.php"><?php echo _('User Guide'); ?></a></p>
<p><?php echo _('Please be sure to watch the following video:'); ?> </p>
</div>
<div class="container">
<video id="video" width="100%" height="100%" poster="./img/uploads/thumbnail.png" autoplay>
  <source src="./vids/uploads/kdjddndndnddiddnd.mp4" type="video/mp4">
...
<input type="hidden" name="systemURL" id="systemURL" value="<?php echo $systemURL;?>">
</body>
</html>